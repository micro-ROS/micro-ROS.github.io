...
Clients and services | Concept available as known from ROS 2. *Convenience functions are under development. The current middleware implementation supports fixed-size message types only.*
