...
This is a follow-up to [Debugging with gdb and openocd](/docs/tutorials/advanced/nuttx/debugging_gdb_openocd/), because the set up done in that tutorial is a pre-requisite to debugging with Visual Studio Code.
 ...
 * All the prerequisites of [Debugging with gdb and openocd](/docs/tutorials/advanced/nuttx/debugging_gdb_openocd/)
