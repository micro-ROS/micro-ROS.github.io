...
---
# Add a new Micro-ROS application to NuttX
...
- This will show a list of the available application, you need to find: ``micro-ROS Ping-Pong`` and click ``y`` to add.
...
Open a console and execute the next commands:
```bash
cd uros_ws/firmware/nuttx
make savedefconfig
```
